...
export const metadata: Metadata = {
  title: "Elizabethtown Heating & Cooling | Expert HVAC Service",  description: "Expert HVAC installation, repair, and maintenance in Elizabethtown and Lancaster County. 35 years of trusted service. PA licensed & insured. Call today.",  keywords: "HVAC Elizabethtown, heating cooling repair installation Lancaster County PA, furnace AC service",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Elizabethtown Heating & Cooling | Expert HVAC Service",    description: "Expert HVAC installation, repair, and maintenance. Trusted by 5,000+ homeowners since 1989.",    siteName: "Elizabethtown Heating & Cooling",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/electrician-installing-laying-electrical-cables-ceiling-inside-house_169016-53070.jpg",        alt: "Elizabethtown Heating & Cooling HVAC Service"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Elizabethtown Heating & Cooling | Expert HVAC Service",    description: "Expert HVAC installation, repair, and maintenance. 35 years of trusted local service.",    images: ["http://img.b2bpic.net/free-photo/electrician-installing-laying-electrical-cables-ceiling-inside-house_169016-53070.jpg"],
  },
};
